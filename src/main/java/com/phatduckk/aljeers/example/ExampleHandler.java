...
public class ExampleHandler extends BaseHandler {
    @GET
    public Object sayHello(AljeersRequest req) {
        return "Hello there";
    }

    @GET
    public Object sayHelloTo(AljeersRequest req) {
        return "Hello there " + req.getParameter("name");
    }

    @GET
    public Object throwAnError(AljeersRequest req) throws Throwable {
        throw new Exception("balls");
    }

    @POST
    public Object postAUser(AljeersRequest req) throws Exception {
        User user = null;
        try {
    ...
    @HEAD
    public void headRequest(AljeersRequest req) {
        return;
    }

    @GET
    public AljeersResponse usingAljeersResponse(AljeersRequest req) {
    ...
    @PUT
    public String putRequest(AljeersRequest req) throws Exception {
    ...
    @GET
    public Map returnAMap(AljeersRequest req) {
